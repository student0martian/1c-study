...
Процедура Печать(ТабДок, Ссылка) Экспорт
	...
	ОбластьИтог = Макет.ПолучитьОбласть("Всего"); //Добавил согласно листинга книги
	ТабДок.Очистить();
	...
	Пока Выборка.Следующий() Цикл
		...
		СуммаИтог = 0; //Добавил согласно листинга книги
		Пока ВыборкаПереченьНоменклатуры.Следующий() Цикл
			...
			СуммаИтог = СуммаИтог + ВыборкаПереченьНоменклатуры.Сумма; //Добавил согласно листинга книги
		КонецЦикла;
		
        ОбластьИтог.Параметры.ВсегоПоДокументу = СуммаИтог; //Добавил согласно листинга книги
        ТабДок.Вывести(ОбластьИтог); //Добавил согласно листинга книги
